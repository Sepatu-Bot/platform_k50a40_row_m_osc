...
LANG_SYNTHETIC_ALIAS = in.txt iw.txt mo.txt no.txt no_NO.txt no_NO_NY.txt sh.txt tl.txt\
kk_Cyrl_KZ.txt kk_KZ.txt zh_CN.txt zh_HK.txt zh_Hans_CN.txt zh_MO.txt\
...
# Ordinary resources
LANG_SOURCE = agq.txt ak.txt am.txt\
 ar_EG.txt ar_LB.txt as.txt asa.txt\
 bas.txt\
 be.txt bem.txt bez.txt bm.txt\
 bn.txt bo.txt\
 ca.txt cgg.txt\
 chr.txt\
 ...
 en_ZM.txt en_ZW.txt\
 eo.txt es.txt\
 et.txt ewo.txt fa.txt\
 ff.txt fo.txt fr.txt\
 ga.txt\
 guz.txt gv.txt ha.txt haw.txt\
 hi.txt hu.txt hy.txt\
 id.txt ig.txt ii.txt it.txt\
 ja.txt jgo.txt jmc.txt kab.txt\
 kam.txt kde.txt kea.txt khq.txt ki.txt\
 kkj.txt kk.txt kk_Cyrl.txt kl.txt kln.txt\
 km.txt ko.txt kok.txt\
 ksf.txt kw.txt\
 lag.txt lg.txt lkt.txt ln.txt\
 ...
 nmg.txt\
 nnh.txt nus.txt nyn.txt om.txt\
 ps.txt\
 rn.txt rof.txt\
 rw.txt rwk.txt saq.txt sbp.txt\
 seh.txt ses.txt sg.txt shi.txt sk.txt sl.txt\
 sn.txt so.txt sq.txt\
 sw.txt swc.txt\
 teo.txt th.txt ti.txt tr.txt\
 twq.txt tzm.txt\
 uk.txt ur.txt\
 vai.txt\
 vi.txt vun.txt xog.txt\
 yav.txt yo.txt zgh.txt zh.txt\
...
#ka.txt sv.txt sv_FI.txt da.txt brx.txt fi.txt pl.txt
#nl.txt nl_BE.txt he.txt or.txt ru.txt lt.txt bg.txt pt.txt
#es.txt sr.txt hr.txt cy.txt dav.txt ro.txt 
...
#ee.txt ky.txt ky_Cyrl.txt mn.txt mn_Cyrl.txt
#uz.txt uz_Arab.txt uz_Arab_AF.txt uz_Cyrl.txt uz_Latn.txt uz_Latn_UZ.txt
#ms_Latn.txt fa_AF.txt fr_CA.txt
