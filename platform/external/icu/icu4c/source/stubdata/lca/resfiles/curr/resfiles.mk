...
CURR_SYNTHETIC_ALIAS = in.txt iw.txt mo.txt no.txt no_NO.txt no_NO_NY.txt sh.txt tl.txt\
ja_JP_TRADITIONAL.txt kk_Cyrl_KZ.txt kk_KZ.txt zh_CN.txt zh_HK.txt zh_Hans_CN.txt zh_MO.txt\
zh_SG.txt zh_TW.txt nb_NO.txt
...
# ks_Arab_IN.txt ks_IN.txt\
# ky_Cyrl_KG.txt ky_KG.txt mn_Cyrl_MN.txt mn_MN.txt\
# ms_BN.txt ms_Latn_MY.txt ms_MY.txt ms_SG.txt\
# nn_NO.txt pa_Guru_IN.txt\
...
# END Android-add
CURR_SOURCE = agq.txt ak.txt\
 ar.txt ar_DJ.txt ar_ER.txt ar_LB.txt ar_SO.txt ar_SS.txt\
 as.txt asa.txt\
 bas.txt be.txt\
 bem.txt bez.txt bg.txt bm.txt bn.txt\
 bo.txt\
 ca.txt cgg.txt\
 chr.txt da.txt dav.txt\
 de.txt dje.txt dua.txt\
 dyo.txt ebu.txt\
 en.txt en_US.txt\
 ...
 haw.txt hi.txt hr.txt\
 hu.txt hy.txt ig.txt ii.txt\
 it.txt it_CH.txt ja.txt jgo.txt\
 jmc.txt kab.txt kam.txt kde.txt\
 kea.txt khq.txt ki.txt kk.txt kk_Cyrl.txt\
 kkj.txt kl.txt kln.txt km.txt\
 ko.txt kok.txt ksb.txt\
 ksf.txt kw.txt lag.txt\
 lg.txt lkt.txt ln.txt\
 lu.txt luo.txt luy.txt\
 mas.txt mer.txt mfe.txt mg.txt\
 mgh.txt mgo.txt mk.txt\
 ms.txt mt.txt mua.txt my.txt naq.txt nb.txt\
 nmg.txt nnh.txt nus.txt nyn.txt\
 om.txt or.txt\
...
#bs_Cyrl.txt bs_Latn.txt bs.txt ug.txt ml.txt nd.txt
...
#te.txt nn.txt ne.txt ne_IN.txt sk.txt gu.txt lv.txt mr.txt pa.txt
#pa_Arab.txt pa_Arab_PK.txt pa_Guru.txt fi.txt cs.txt
...
#mas_TZ.txt ms_Latn.txt ms_Latn_BN.txt ru_BY.txt
#ms_Latn_SG.txt nl_AW.txt nl_BQ.txt nl_CW.txt nl_SR.txt nl_SX.txt
#om_KE.txt pt_PT.txt pt_ST.txt pt_TL.txt ro_MD.txt
#ru_KG.txt ru_KZ.txt ru_MD.txt shi_Latn.txt shi_Tfng.txt shi_Tfng_MA.txt
#so_DJ.txt so_ET.txt so_KE.txt sw_UG.txt teo_KE.txt
#ug_Arab.txt vai_Latn.txt vai_Latn_LR.txt vai_Vaii.txt 
