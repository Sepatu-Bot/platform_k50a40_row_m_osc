...
COLLATION_SYNTHETIC_ALIAS = in.txt iw.txt\
 mo.txt no.txt no_NO.txt\
 sh.txt zh_CN.txt zh_HK.txt zh_Hans.txt zh_Hans_CN.txt zh_Hans_SG.txt\
 zh_Hant_HK.txt zh_Hant_MO.txt zh_Hant_TW.txt zh_MO.txt zh_SG.txt\
 zh_TW.txt nb_NO.txt
#de_.txt de__PHONEBOOK.txt es_.txt es__TRADITIONAL.txt in_ID.txt
#he_IL.txt id_ID.txt iw_IL.txt
#pa_Guru.txt pa_Guru_IN.txt pa_IN.txt ro_MD.txt 
