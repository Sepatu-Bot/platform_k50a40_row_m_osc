...
void p2p_invitation_req_cb(struct p2p_data *p2p, int success)
{
	...
	if (!success) {
		/*
		* Invitation Request TX failed, peer maybe on different
		* channels due to switch to
		* p2p find phase, trigger p2p find phase to
		* update peer device listen channel,
