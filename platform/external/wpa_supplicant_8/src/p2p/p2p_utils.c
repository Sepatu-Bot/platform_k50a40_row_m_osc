...
/**
 * mtk_p2p_channel_to_freq - Convert channel info to frequency
 * @channel: Channel number
 * Returns: Frequency in MHz or -1 if the specified channel is unknown
 * NOTE:
 * Some 80211 devices will not fill correct channel op_class & channel,
 * we need a function Convert channel to frequency without op_class
 */
